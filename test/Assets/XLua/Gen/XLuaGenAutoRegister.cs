...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(DelegetEvent), DelegetEventWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LoadLua), LoadLuaWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaAdd), LuaAddWrap.__Register);
